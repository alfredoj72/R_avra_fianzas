...
# datos_con_geometria  <- datos_para_analisis_2022[["datos"]]
# datos <- st_drop_geometry(datos_con_geometria)
...
diccionario_campos <- read_excel(here("datos_output","campos_avra_catastro_completados.xlsx")) 
...
#   num %>%
#     formatC(format = "f", digits = decimales, big.mark = ".", decimal.mark = ",")
# }
...
crear_mapa_barrio <- function(barrios_de_un_municipio){
  gg <-
    ...
    scale_fill_brewer(palette = "YlOrBr",
                      name="Mediana Precio del alquiler mensual por m2",
                      na.value = "gray95",
