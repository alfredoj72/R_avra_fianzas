...
rmarkdown::render(
  input = here("Informes_publicaciones","Informe_barrios_salida_pdf.Rmd"),
...
rmarkdown::render(
  input = here("Informes_publicaciones","Informe_provincias_salida_html.Rmd"),
  output_file = here("Out_informes", 
...
rmarkdown::render(
  input = here("Informes_publicaciones","Informe_municipios_salida_regional_html.Rmd"),
  output_file = here("Out_informes", 
                     glue("Informe_municipios_regional_{Sys.Date()}.html")) ) 

rmarkdown::render(
  input = here("Informes_publicaciones","Informe_municipios_salida_html.Rmd"),
  output_file = here("Out_informes", 
